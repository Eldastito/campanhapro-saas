...
import { Headset, Lock, Loader2, CheckCircle2, ShieldCheck } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-[#0a0a0b] text-white flex items-center justify-center p-6">
        <div className="max-w-md w-full bg-slate-900/60 border border-emerald-500/30 rounded-3xl p-8 text-center">
          ...
          <p className="text-sm text-slate-400 mt-1 mb-5">Sua conta de atendimento está pronta. Faça login para começar.</p>
    ...
    <div className="min-h-screen bg-[#0a0a0b] text-white flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-slate-900/60 border border-white/10 rounded-3xl p-8">
        <div className="text-center mb-5">
          ...
          <h1 className="text-2xl font-black mt-1">Equipe de Atendimento</h1>
        </div>
        ...
        <p className="text-[11px] text-slate-500 mt-3 flex items-center gap-1.5"><ShieldCheck className="w-3.5 h-3.5" /> Acesso restrito ao atendimento — você verá apenas as conversas da fila.</p>
      </div>
    </div>
  );
};
